<script setup>
import { ref } from 'vue'
import { getCheckOut, createOrder } from '@/api/checkout'
import { useCartStore } from '@/stores'
import router from '@/router'
const cartStore = useCartStore()
const checkInfo = ref({}) // 订单对象
const checkList = ref([])
checkList.value = cartStore.checkList
...
const goPay = async () => {
  const {
    ...
    payChannel: 1,
    buyerMessage: '',
    goods: checkList.value.map((item) => {
      return {
        skuId: item.skuId,
        count: item.count
      }
      ...
      <div class="wrapper">
        ...
        <div class="box-body">
          <div class="address">
            ...
            >
              <div class="addressWrapper">
                <div
                  ...
                  :key="item.id"
                  :class="{ active: activeAdress.id === item.id }"
                  @click="activeAdress = item"
                >
                  <ul>
                    <li>
            ...
            <!-- <el-dialog title="添加地址" v-model="addFlag">
              <el-form>
                <el-form-item>
        ...
        <div class="box-body">
          <div class="total">
            <dl>
              <dt>商品件数：</dt>
              <dd>{{ cartStore.checkCount }}件</dd>
            </dl>
            <dl>
              <dt>商品总价：</dt>
              <dd>¥{{ cartStore.checkPrice.toFixed(2) }}</dd>
            </dl>
            <dl>
              <dt>运<i></i>费：</dt>
            ...
            <dl>
              ...
              <dd class="price">
                {{
                  (checkInfo.summary?.postFee + cartStore.checkPrice).toFixed(2)
                }}
              </dd>
            </dl>
          </div>
